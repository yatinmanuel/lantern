...
import { Plus, Trash2, Edit, Check, X, Search, Monitor, Disc } from 'lucide-react';
  ...
  return (
    <div className="flex h-full flex-col bg-background">
      <div className="flex h-16 shrink-0 items-center justify-between border-b px-6">
         <div>
            <h2 className="text-lg font-semibold">Boot Configuration</h2>
            <p className="text-sm text-muted-foreground">Manage PXE boot menus and client overrides.</p>
         </div>
      </div>
